 ...
 * docs.diadata.org for supported chains.
 */
...
library DIAOracleLib {
     ...
     * @return latestPrice - The price of the asset specified.
     * @return timestampOflatestPrice - The timestamp of the latest price.
     */
    function getPrice(
        address oracle,
        string memory key
